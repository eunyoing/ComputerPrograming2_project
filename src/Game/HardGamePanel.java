...
class HardGamePanel extends JPanel {
    ...
    private void initMap(String difficulty) {
        platforms.add(new Platform(0, WINDOW_HEIGHT - FLOOR_HEIGHT - 20, 4300 , FLOOR_HEIGHT)); // 바닥 1층 플랫폼
        platforms.add(new Platform(1300, WINDOW_HEIGHT - FLOOR_HEIGHT * 2, 300, 20)); // 1층 2층 사이 바닥
        platforms.add(new Platform(0, WINDOW_HEIGHT - FLOOR_HEIGHT * 3-10, 3000, 40)); // 2층
        platforms.add(new Platform(4300, WINDOW_HEIGHT - FLOOR_HEIGHT * 2, 100, 20));
        platforms.add(new Platform(4150, WINDOW_HEIGHT - FLOOR_HEIGHT * 2-50, 100, 20));
        ...
        obstacles.add(new TriangleObstacle(3100, WINDOW_HEIGHT - FLOOR_HEIGHT - 75, false));
        obstacles.add(new TriangleObstacle(3250, WINDOW_HEIGHT - FLOOR_HEIGHT - 75, false));
        obstacles.add(new TriangleObstacle(3450, WINDOW_HEIGHT - FLOOR_HEIGHT - 75, false));
        obstacles.add(new TriangleObstacle(3600, WINDOW_HEIGHT - FLOOR_HEIGHT - 75, false));
        obstacles.add(new TriangleObstacle(3800, WINDOW_HEIGHT - FLOOR_HEIGHT - 75, false));
        obstacles.add(new TriangleObstacle(3950, WINDOW_HEIGHT - FLOOR_HEIGHT - 75, false));
        obstacles.add(new TriangleObstacle(4325, WINDOW_HEIGHT - FLOOR_HEIGHT * 2-55, false));//2층 올라가는 바닥 가시
        obstacles.add(new TriangleObstacle(4175, WINDOW_HEIGHT - FLOOR_HEIGHT * 2-105, false));

        obstacles.add(new TriangleObstacle(200, WINDOW_HEIGHT - FLOOR_HEIGHT * 3 - 66, false)); // y: 2층 바닥 y좌표 - 장애물 height
        obstacles.add(new TriangleObstacle(900, WINDOW_HEIGHT - FLOOR_HEIGHT * -80, false)); //2층 바닥 장애물
        obstacles.add(new TriangleObstacle(2600, WINDOW_HEIGHT - FLOOR_HEIGHT * 3 - 66, false));
        obstacles.add(new TriangleObstacle(2710, WINDOW_HEIGHT - FLOOR_HEIGHT * 3 - 66, false));
        obstacles.add(new TriangleObstacle(2820, WINDOW_HEIGHT - FLOOR_HEIGHT * 3 - 66, false));
        ...
        items.add(new Item(300, WINDOW_HEIGHT - FLOOR_HEIGHT * 5 - 20, 50)); //item 위치

        platforms.add(new Platform(400, WINDOW_HEIGHT - FLOOR_HEIGHT * 4, 300, 20)); //3층
        obstacles.add(new TriangleObstacle(500, WINDOW_HEIGHT - FLOOR_HEIGHT * 4 - 56, false)); // y: 3    층 바닥 y좌표 - 장애물 height
        ...
        rotatingObstacles.add(new RotatingObstacle(3200, WINDOW_HEIGHT - FLOOR_HEIGHT - 45, 100));
        rotatingObstacles.add(new RotatingObstacle(3550, WINDOW_HEIGHT - FLOOR_HEIGHT - 45, 100));
        rotatingObstacles.add(new RotatingObstacle(3900, WINDOW_HEIGHT - FLOOR_HEIGHT - 45, 100));
        ...
        platforms.add(new Platform(3000, WINDOW_HEIGHT - FLOOR_HEIGHT * 3-10, 40, 20, 3, 3000, 3200));
        platforms.add(new Platform(3300, WINDOW_HEIGHT - FLOOR_HEIGHT * 3-10, 40, 20, 2, 3300, 3500));
        platforms.add(new Platform(3600, WINDOW_HEIGHT - FLOOR_HEIGHT * 3-10, 40, 20, 3, 3600, 3800));
        platforms.add(new Platform(3900, WINDOW_HEIGHT - FLOOR_HEIGHT * 3-10, 40, 20, 2, 3900, 4100));
        ...
        clouds.add(new cloud(3000, WINDOW_HEIGHT - FLOOR_HEIGHT * 8 - 40, 90, 60));
        clouds.add(new cloud(3240, WINDOW_HEIGHT - FLOOR_HEIGHT * 8 - 80, 66, 44));
        clouds.add(new cloud(3250, WINDOW_HEIGHT - FLOOR_HEIGHT * 8, 51, 34));
        clouds.add(new cloud(3800, WINDOW_HEIGHT - FLOOR_HEIGHT * 8 - 80, 99, 66));
        clouds.add(new cloud(4300, WINDOW_HEIGHT - FLOOR_HEIGHT * 8 - 10, 66, 44));
        clouds.add(new cloud(4500, WINDOW_HEIGHT - FLOOR_HEIGHT * 8 - 60, 90, 60));
        clouds.add(new cloud(5000, WINDOW_HEIGHT - FLOOR_HEIGHT * 8 - 10, 60, 40));
        clouds.add(new cloud(5200, WINDOW_HEIGHT - FLOOR_HEIGHT * 8 - 80, 66, 44));
        clouds.add(new cloud(5500, WINDOW_HEIGHT - FLOOR_HEIGHT * 8 - 60, 51, 34));
        clouds.add(new cloud(5800, WINDOW_HEIGHT - FLOOR_HEIGHT * 8 - 90, 90, 60));
    ...
    private void endGame() {
        ...
        rank.saveUserData("hard", playername, formattedTime); // 하드 난이도 데이터 저장
